...
public class SecurityAwareEnergyEfficientVMConsolidation {
    ...
    private static final int CLOUDLET_LENGTH = 300000;
    ...
    private Datacenter createDatacenter() {
        ...
        for(int i = 0; i < HOSTS; i++) {
            Host host = createHost(random.nextInt(10) + 1);
            hostList.add(host);
        }
        System.out.println();
    ...
    private List<Vm> createVms() {
        ...
        for (int i = 0; i < VMS; i++) {
            ...
            if (i > VMS / 2) {
                vm.setSubmissionDelay(550);
            }
            // if (i >= VMS * 2 / 3) {
            //     vm.setSubmissionDelay(700);
            // }
    ...
    private List<Cloudlet> createCloudlets() {
        ...
        for (int i = 0; i < CLOUDLETS; i++) {
            ...
            if (i > CLOUDLETS / 2) {
                cloudlet.setSubmissionDelay(600);
            }
            // if (i >= CLOUDLETS * 2 /3) {
